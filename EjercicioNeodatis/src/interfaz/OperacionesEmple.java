...
public class OperacionesEmple extends JDialog {
	...
	private final class Modif implements ActionListener {
	...
	private final class Consult implements ActionListener {
	...
	public OperacionesEmple() {
		...
		btnInsertar.addActionListener(new Insert());
		
		//Accion boton consultar
		btnConsultar.addActionListener(new Consult());
		
		//Accion boton borrar
		btnBorrar.addActionListener(new Borrar());
		
		//Accion boton modificar
		btnModificar.addActionListener(new Modif());
	}
}
